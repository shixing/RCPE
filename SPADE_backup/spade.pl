...
#$CHP = "/Users/xingshi/Workspace/dp/CharniakParser/";
$CHP = "/home/xingshi/workspace/dp/CharniakParser/";
$SPP = "/home/xingshi/workspace/dp/SPADE/bin/";
...
if( scalar(@ARGV)!= 1 && scalar(@ARGV)!= 2 ){
    ...
    if( $argv eq "-seg-only" ){
	$argv = shift;
	@args = ("$CHP/parseIt -LEn $CHP/DATA/ $argv > $argv.chp");
